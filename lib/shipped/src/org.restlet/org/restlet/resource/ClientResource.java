 ...
 * This class changes the semantics of the {@link org.restlet.resource.UniformResource#getRequest()}
 * and {@link org.restlet.resource.UniformResource#getResponse()} methods. Since a clientResource may
 ...
 * once. Some others, such as {@link org.restlet.representation.StringRepresentation} stored the entity in
 ...
 * lower-level {@link org.restlet.Client} class instead.
 * 
...
public class ClientResource extends UniformResource {
     ...
     * {@link org.restlet.Client} based on the protocol of the resource's URI reference.
     * 
     ...
     * the latest with {@link #setResponse(org.restlet.Response)}. If necessary the
     * {@link #setNext(org.restlet.Uniform)} method is called as well with a {@link org.restlet.Client}
     ...
     * created and the {@link #handle(org.restlet.Request, org.restlet.Response, java.util.List, int, org.restlet.Uniform)}
     * method is invoked and the response set as the latest response with
     * {@link #setResponse(org.restlet.Response)}.
     * 
     * @param request
     ...
     * {@link #handle(org.restlet.Request, org.restlet.Response, java.util.List, int, org.restlet.Uniform)} method invoked.
     * 
     * @param request
     *            The request to send.
     * @param response
     ...
     *            server.
     * @see org.restlet.Request#setChallengeResponse(org.restlet.data.ChallengeResponse)
     */
     ...
     * @see org.restlet.Request#setClientInfo(org.restlet.data.ClientInfo)
     */
     ...
     * @see org.restlet.Request#setConditions(org.restlet.data.Conditions)
     */
     ...
     * @see org.restlet.Request#setCookies(org.restlet.util.Series)
     */
     ...
     * @param hostRef
     *            The host reference.
     * @see org.restlet.Request#setHostRef(org.restlet.data.Reference)
     */
     ...
     * @param hostUri
     *            The host URI.
     * @see org.restlet.Request#setHostRef(String)
     */
     ...
     * @param method
     *            The method called.
     * @see org.restlet.Request#setMethod(org.restlet.data.Method)
     */
     ...
     * @see org.restlet.Request#setOriginalRef(org.restlet.data.Reference)
     */
     ...
     * @param ranges
     *            The ranges.
     * @see org.restlet.Request#setRanges(java.util.List)
     */
     ...
     * @see org.restlet.Request#setResourceRef(org.restlet.data.Reference)
     */
     ...
     * @param uri
     *            The resource URI.
     * @see org.restlet.Request#setResourceRef(String)
     */
     ...
     * @see org.restlet.Request#setReferrerRef(org.restlet.data.Reference)
     */
     ...
     * @param referrerUri
     *            The referrer URI.
     * @see org.restlet.Request#setReferrerRef(String)
     */
