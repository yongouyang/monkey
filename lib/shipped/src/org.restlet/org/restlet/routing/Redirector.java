...
public class Redirector extends Restlet {
     ...
     * returned to the client. In this case, you can view the {@link org.restlet.routing.Redirector}
     * as acting as a transparent server-side proxy Restlet.<br>
     * <br>
     * Remember to add the required connectors to the parent {@link org.restlet.Component}
     * and to declare them in the list of required connectors on the
     * {@link org.restlet.Application#getConnectorService()} property.<br>
     * <br>
     ...
     * 
     * @see org.restlet.Application#getOutboundRoot()
     * @see org.restlet.Context#getClientDispatcher()
     */
     ...
     * response comes back the headers are also removed.
     * 
     * @see org.restlet.Context#getServerDispatcher()
     */
