...
public abstract class Filter extends Restlet {
     ...
     * returned from the {@link #beforeHandle(org.restlet.Request, org.restlet.Response)} method, the
     * filter then invokes the {@link #doHandle(org.restlet.Request, org.restlet.Response)} method. If
     * returned from the {@link #doHandle(org.restlet.Request, org.restlet.Response)} method, the filter
     * then invokes the {@link #afterHandle(org.restlet.Request, org.restlet.Response)} method.
     */
    public static final int CONTINUE = 0;

    /**
     * Indicates that after the {@link #beforeHandle(org.restlet.Request, org.restlet.Response)} method,
     * the request processing should skip the
     * {@link #doHandle(org.restlet.Request, org.restlet.Response)} method to continue with the
     * {@link #afterHandle(org.restlet.Request, org.restlet.Response)} method.
     */
    ...
    /**
     * Sets the next {@link org.restlet.Restlet} as a {@link org.restlet.resource.Finder} for a given
     * {@link org.restlet.resource.ServerResource} class. When the call is delegated to the
     * {@link org.restlet.resource.Finder} instance, a new instance of the resource class will be
