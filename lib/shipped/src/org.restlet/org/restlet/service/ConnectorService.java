 ...
 * use.<br>
 * <br>
 * If you need to override the {@link #afterSend(org.restlet.representation.Representation)} method for
 * example, just create a subclass and set it on your application with the
 * {@link org.restlet.Application#setConnectorService(org.restlet.service.ConnectorService)} method.<br>
 * <br>
