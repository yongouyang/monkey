...
public abstract class Authenticator extends Filter {
     ...
     * {@link #authenticate(org.restlet.Request, org.restlet.Response)} method. Then, depending on the
     * result and the mode set, it invokes the
     * {@link #authenticated(org.restlet.Request, org.restlet.Response)} or the
