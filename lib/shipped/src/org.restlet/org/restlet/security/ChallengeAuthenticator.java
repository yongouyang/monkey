...
public class ChallengeAuthenticator extends Authenticator {
     ...
     *            The authentication realm.
     * 
     * @see #ChallengeAuthenticator(org.restlet.Context, boolean, org.restlet.data.ChallengeScheme, String,
     ...
     * {@link #challenge(org.restlet.Response, boolean)} is invoked.<br>
     * <br>
     * If the credentials are invalid and if the "rechallenge" property is true
     * then {@link #challenge(org.restlet.Response, boolean)} is invoked. Otherwise,
     * {@link #forbid(org.restlet.Response)} is invoked.<br>
     * <br>
     * If the credentials are stale, then {@link #challenge(org.restlet.Response, boolean)}
     ...
     * {@link #forbid(org.restlet.Response)} will be called.
     * 
