...
public class TemplateDispatcher extends Client {
     ...
     * original reference ({@link org.restlet.Request#getOriginalRef()} with the the
    ...
    /**
     * Returns the context. Override default behavior from {@link org.restlet.Restlet}.
     * 
     * @return The context.
     */
    @Override
    ...
    /**
     * Sets the context. Override default behavior from {@link org.restlet.Restlet}.
     * 
     * @param context
     *            The context to set.
     */
