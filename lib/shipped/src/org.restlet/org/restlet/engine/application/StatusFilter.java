...
public class StatusFilter extends Filter {
     ...
     * is caught, the {@link #getStatus(Throwable, org.restlet.Request, org.restlet.Response)} method is
     * invoked.
     * 
     * @param request
     *            The request to handle.
     ...
     * {@link org.restlet.data.Status#SERVER_ERROR_INTERNAL} status including the related error
     ...
     * @see #getDefaultRepresentation(org.restlet.data.Status, org.restlet.Request, org.restlet.Response)
     */
