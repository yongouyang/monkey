...
public class Buffer {
     ...
     * {@link java.nio.ByteBuffer#allocate(int)} or
     * {@link java.nio.ByteBuffer#allocateDirect(int)} methods.
     * 
     * @param bufferSize
     *            The byte buffer size.
     * @param direct
    ...
    /**
     * Indicates if the buffer state has the {@link org.restlet.engine.io.BufferState#DRAINING} value.
     * 
     * @return True if the buffer state has the {@link org.restlet.engine.io.BufferState#DRAINING}
     *         value.
     */
    ...
    /**
     * Indicates if the buffer state has the {@link org.restlet.engine.io.BufferState#FILLING} value.
     * 
     * @return True if the buffer state has the {@link org.restlet.engine.io.BufferState#FILLING}
     *         value.
     */
