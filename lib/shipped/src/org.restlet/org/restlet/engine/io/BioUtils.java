...
public final class BioUtils {
     ...
     * {@link org.restlet.representation.Representation#getSize()} if no range is defined, otherwise it
     ...
     */
    public static OutputStream getOutputStream(Writer writer) {
     ...
     * @see #toString(java.io.InputStream, org.restlet.data.CharacterSet)
     * @param inputStream
     *            The input stream.
